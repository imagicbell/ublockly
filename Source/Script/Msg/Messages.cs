...
// Text Blocks.
            ...
            {
                "TEXT_CHARAT_TITLE", "in text %1 get %2 %3 %4"
            },
            ...
            /// https://github.com/google/blockly/wiki/Text#extracting-a-single-character].
            /// [[File:Blockly-text-get.png]]
            {"TEXT_CHARAT_FROM_END", "letter # from end"},
            ...
            /// https://github.com/google/blockly/wiki/Text#extracting-a-single-character].
            /// [[File:Blockly-text-get.png]]
            {"TEXT_CHARAT_FIRST", "first letter"},
            ...
            /// https://github.com/google/blockly/wiki/Text#extracting-a-single-character].
            /// [[File:Blockly-text-get.png]]
            {"TEXT_CHARAT_RANDOM", "random letter"},
            ...
            {"TEXT_GET_SUBSTRING_INPUT_IN_TEXT", "in text %1 get substring from %2 %3 %4 to %5 %6 %7"},
...
// Variables Blocks.
            ...
            {"VARIABLES_CHANGE_HELPURL", "https://en.wikipedia.org/wiki/Programming_idiom#Incrementing_a_counter"},
            {"VARIABLES_CHANGE_TITLE", "change %1 by %2"},
            {"VARIABLES_CHANGE_TITLE_ITEM", "item"},
...
/**********************Coroutine define***/            
            ...
            {"TIME_UNIT_TOO_HIGH", "too high to count"}
        };
    }
}
