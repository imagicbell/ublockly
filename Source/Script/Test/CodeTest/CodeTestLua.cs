...
{
    [PTTestUnitInfo("Lua Test Code Generator, Interpreter")]
    public class CodeTestLua : PTTestUnit
    {
        ...
        IEnumerator Run()
        {
            ...
            while (true)
            {
                if (string.IsNullOrEmpty(mCode) || mTestUnit != lastTestUnit)
                {
                    ...
                    File.WriteAllText(string.Format(Application.dataPath + "/../PersistentPath/PTBlockly/{0}.lua", mTestUnit), mCode);
        ...
        void View()
        {
            ...
            bool toggle = GUI.Toggle(new Rect(20, 10, 100, 40), toggleCode, "Lua");
